        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav">
                ...
                if (isset($_SESSION['admin'])) {
                    ...
                    <li class="active"><a href="admin_user.php">Felhasználók listája</a></li>
...
<div class="table-responsive orderrows wow slideInUp">
    <table class="table">
        ...
        $sql = "SELECT id_user, first_name, surname, email, datetime FROM users";
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($record = mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-default" href="admin_user2.php?id=<?php echo $record['id_user'] ?>">Módosítás</a>
                    </td>
                </tr>
                </tbody>
                <?php
